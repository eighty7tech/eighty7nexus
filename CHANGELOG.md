...
### Fixed:
- **Demo Credentials Mismatch**: Fixed a bug where the UI demo credentials did not match the seeded passwords generated by `seed.mjs`, leading to 'Wrong email or password' and account lockout errors.
